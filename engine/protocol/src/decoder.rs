...
use rlogs_events::{
    ...
    CanonicalEventDraftKind, CharacterIdentity, CharacterProfilePatch, CooldownEvent, DamageEvent,
    DamageFlags, DataGapEvent, DataGapKind, EntityAttribute, EntityAttributeEvent,
    ...
    PositionEvent, RegionContext, RegionEvidence, RegionEvidenceKind, RegionIdentity, RunState,
    SceneId, TimelineEventKind, WorldContext,
};
...
use crate::{
    AllowedDataDomain, CaptureGapKind, CaptureRecord, CaptureRecordKind, DecodeDisposition,
    GameBuild, ProhibitedDataClass, ProtocolPack,
};
    ...
    if let Some(character_id) = character_id {
        drafts.push(draft(
            ...
            CanonicalEventDraftKind::CharacterProfileObserved {
                profile: Box::new(CharacterProfilePatch {
