...
- `2110092` — Stunt! Blade Sweep / Arcane! Goblin March — Target Armor Reduction: Packet-owned provider selection and the observed provider's equipped tier are proven for the reviewed current-build lifecycle. Reconstruct the defense-affected ATK or MATK subtotal, event-time target defense and penetration overlap, combat-stage placement, stacking arbitration, integer rounding, and conserved marginal for the equipped-tier 1.3/2.6/3.9/5.2/6.5% Armor reduction.
