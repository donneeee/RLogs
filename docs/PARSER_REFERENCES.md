...
Source is not copied without a deliberate license and provenance review. The
BPSR module optimizer is an explicit reviewed exception: its behavior is
ported into an isolated Rust crate under the compatible AGPL-3.0 license and
...
| [resonance-logs-cn](https://github.com/fudiyangjin/resonance-logs-cn) | `0.2.0` at `ccdeef23c7806be5072f95a9e80b103794af3544` | Pinned CN-region protocol/feature baseline and attributed AGPL-3.0 module-optimizer behavior |
